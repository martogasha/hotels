            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        <div>
                            <h3 class="title font-size-24">California: 22 Tours found</h3>
                    ...
                    <div class="filter-bar d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown-item">
                                            <div class="checkbox-wrap">
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="catChb1">Activity Adventure Tours</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                ...
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="catChb3">Escorted Tours</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                ...
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="catChb5">Group Tours</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb6">
                                                    <label for="catChb6">Family Tours</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb7">
                                                    <label for="catChb7">City Tours</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb8">
                                                    <label for="catChb8">National Park Tours</label>
                                                </div>
                                            </div>
                                        </div><!-- end dropdown-item -->
                                    </div><!-- end dropdown-menu -->
                        ...
                        <div class="select-contain">
                            <select class="select-contain-select">
                                ...
                                <option value="3">Popular Tour</option>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="btn-box mt-3 text-center">
                    ...
                    <p class="font-size-13 pt-2">Showing 1 - 6 of 22 Tours</p>
                </div><!-- end btn-box -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
    </div><!-- end container -->
...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/tour-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Sep 2021 10:48:09 GMT -->
</html>
