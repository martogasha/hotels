            ...
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    <div class="footer-logo padding-bottom-30px">
                        <a href="{{url('/')}}" class="foot__logo"><img src="{{asset('images/hotel.jpeg')}}" alt="logo"></a>
                    </div><!-- end logo -->
                    <p class="footer__desc">Hotels Booking in Kenya makes it easy and backs it all up with 24/7 customer support.</p>
                    <ul class="list-items pt-3">
                        <li><a href="#"><i class="la la-phone mr-1"></i>0727995279</a></li>
                        <li><a href="#">info@hotelsbookinginkenya.co.ke</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                <div class="copy-right padding-top-30px">
                    <p class="copy__desc">
                        &copy; Copyright hotelsbookinginkenya 2010--2021. Made by <a href="https://iconztech.com/">www.iconztech.com</a>
                    </p>
                </div><!-- end copy-right -->
            </div><!-- end col-lg-7 -->
            <div class="col-lg-5">
