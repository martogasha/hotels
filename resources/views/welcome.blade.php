                                ...
                                <div class="tab-pane fade show active" id="one-way" role="tabpanel" aria-labelledby="one-way-tab">
                                    <div class="contact-form-action">
                                        <form action="#" class="row align-items-center">
                                            ...
                                            <div class="col-lg-3">
                                                <a href="{{url('search')}}" class="theme-btn w-100 text-center margin-top-20px">Search Now</a>
                                            </div>
                                        </form>
                                    </div>
                                </div><!-- end tab-pane -->
...
<section class="destination-area section--padding" style="padding-top:50px">
    <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="section-heading">
                ...
                <div class="col-lg-4">
                    <div class="btn-box btn--box text-right">
                        <a href="{{url('listing')}}" class="theme-btn">Discover More</a>
                    </div>
                </div>
            </div><!-- end row -->
        <div class="row padding-top-50px">
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="images/NAIROBI CITY.JPG" alt="destination-img">
                ...
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="images/MOMBASA CITY.JPG" alt="destination-img">
            ...
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="images/NAKURU CITY.JPG" alt="destination-img">
            ...
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="images/ELDORET.JPG" alt="destination-img">
...
<!-- ================================
    END ROUND-TRIP AREA
================================= -->
<section class="hotel-area section-bg section-padding overflow-hidden padding-right-100px padding-left-100px" style="padding-top:10px">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <h2 class="sec__title line-height-55">Browse by property type
                    </h2>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
                ...
                <div class="hotel-card-wrap">
                    <div class="hotel-card-carousel carousel-action">
                        <div class="card-item mb-0">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">Hotels</a></h3>
                                <p class="card-meta">5 Hotels</p>
                            </div>
                        </div><!-- end card-item -->
                        <div class="card-item mb-0">
                            <div class="card-img">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">Apartments</a></h3>
                                <p class="card-meta">5 Apartments</p>
                            </div>
                        </div><!-- end card-item -->
                        <div class="card-item mb-0">
                            <div class="card-img">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">Resorts</a></h3>
                                <p class="card-meta">5 Resorts</p>
                            </div>
                        </div><!-- end card-item -->
                        <div class="card-item mb-0">
                            <div class="card-img">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">Villas</a></h3>
                                <p class="card-meta">5 Villas</p>
                            </div>
                        </div><!-- end card-item -->
                        <div class="card-item mb-0">
                            <div class="card-img">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">Cabins</a></h3>
                                <p class="card-meta">5 Cabins</p>
                            </div>
                        </div><!-- end card-item -->
...
<!-- ================================
    START HOTEL AREA
================================= -->
<section class="hotel-area section-bg section-padding overflow-hidden padding-right-100px padding-left-100px" style="padding-top:0px">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="section-heading">
                        ...
                        <div class="card-item mb-0">
                            <div class="card-img">
                                <a href="{{url('single',$hotel->id)}}" class="d-block">
                                    <img src="{{asset('uploads/product/'.\App\Models\Image::where('hotel_id',$hotel->id)->first()->image)}}" alt="hotel-img">
                                </a>
{{--                                <span class="badge">Bestseller</span>--}}
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
                                    <i class="la la-heart-o"></i>
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="{{url('single',$hotel->id)}}">{{$hotel->hotel_name}}</a></h3>
                                ...
                                <div class="card-price d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{url('single',$hotel->id)}}" class="btn-text">See details<i class="la la-angle-right"></i></a>
                                </div>
                            </div>
                        </div><!-- end card-item -->
                        @endforeach
...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Sep 2021 10:12:07 GMT -->
</html>
